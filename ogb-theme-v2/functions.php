...
function load_stylesheets() 
{
    ...
    wp_register_style('font-awesome', get_template_directory_uri() . '/css/fontawesome-free/css/fontawesome.min.css', array(), false,  'all');
    ...
    wp_register_style('landing', get_template_directory_uri() . '/css/landing/landing-page-2.css', array(), false,  'all');
